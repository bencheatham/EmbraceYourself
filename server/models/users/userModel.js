...
var userTableSure = function (connectionString, tripTableSure) {
  ...
  client.connect(function(err) {
    ...
    var query1 = client.query('CREATE TABLE IF NOT EXISTS users(id SERIAL PRIMARY KEY, username VARCHAR(255), password VARCHAR(255), first_name VARCHAR(255), last_name VARCHAR(255), email VARCHAR(255), birth_date VARCHAR(255), profile_pic TEXT,  city VARCHAR(255), state VARCHAR(255), zip_code INTEGER, biography TEXT)');
